...
def download_google_images(search_query: str, number_of_images: int) -> str:
    ...
    url = 'https://www.google.com/search?q=google+jennifer+aniston+images&tbm=isch&ved=2ahUKEwjTiczyncyBAxVPz6ACHZyJC7IQ2-cCegQIABAA&oq=google+jennifer+aniston+images&gs_lcp=CgNpbWcQAzoECCMQJzoICAAQgAQQsQM6BQgAEIAEOggIABAIEAcQHjoGCAAQCBAeUOseWP46YPdAaABwAHgAgAGHAYgB1A-SAQQzLjE1mAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=h-EUZZOqM8-eg8UPnJOukAs&bih=571&biw=1280'
